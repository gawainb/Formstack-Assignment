...
2. Clone this repository into your local machine using the terminal (mac) or Gitbash (PC) `> git clone https://github.com/gawainb/appointment.git`
3. CD to the folder `cd appointment`
4. Run `> npm install` to install the project dependencies
5. Run `> npm start` command to start the automation

## Instructions to Run Flow

1. Run `npm run flow` to start flow tests
